...
import com.bolsadeideas.springoot.app.models.entity.Factura;
...
public class FacturaController {
    ...
    public String crear(@PathVariable(value = "clienteId") Cliente cliente, Model model, RedirectAttributes flash) {
